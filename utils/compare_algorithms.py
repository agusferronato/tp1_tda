...
from utils.generate_data_sets import generate_random_data_sets, EXPECTED_RESULTS_PATH, FOLDER
    ...
    for size in range(MIN_SIZE, MAX_SIZE):
        ...
        for k in range(2, size - 1):
            ...
            for algorithm in [alp, lp, bt, pakku]:
                ...
                results[algorithm][size][k].append([value, time.time() - start, value / optimal_value[file]])
